...
def extract_predicted_regions(
    ...
    timing["connected_components_ms"] = timing.get("connected_components_ms", 0.0) + (time.perf_counter_ns() - started) / 1_000_000
    ...
    timing["bounding_box_extraction_ms"] = timing.get("bounding_box_extraction_ms", 0.0) + (time.perf_counter_ns() - started) / 1_000_000
    ...
    timing["region_filtering_ms"] = timing.get("region_filtering_ms", 0.0) + (time.perf_counter_ns() - started) / 1_000_000
