    ...
    <div className="w-full max-w-7xl mx-auto px-4 md:px-6 py-6 pb-28 md:pb-12">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 border-b-2 border-outline-variant pb-6 mb-6">
        ...
        <div className="flex flex-wrap items-center gap-2 md:gap-3">
          ...
          <button type="button" onClick={onStartNewSession} className="flex items-center gap-1.5 px-3 py-2 border border-primary text-primary rounded-lg font-bold text-xs hover:bg-primary/10 focus-visible:ring-2 focus-visible:ring-primary">
        ...
        <section className="mb-6 rounded-xl bg-surface-container-low p-5 ring-1 ring-outline-variant" aria-labelledby="analysis-progress-title">
          ...
          <ol className="mt-4 grid gap-2 text-sm sm:grid-cols-3 lg:grid-cols-6">
            ...
            {[
              ...
              const order = ['WAITING','IQA','IQA_GOOD','IQA_USABLE','IQA_REJECTED','RESTORING','RESTORATION_COMPLETE','GRADING','LESION_ANALYSIS','PREPARING_RESULTS','COMPLETE'];
