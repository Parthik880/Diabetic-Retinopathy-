...
export const VIEW_LABELS: Record<AnalysisView, string> = {
  grade: 'Grade Analysis', attention: 'Lesion Probability', detection: 'Lesion Detection', annotation: 'Lesion Annotation',
};
...
export const INITIAL_SETTINGS: ViewSettings = { imageMode: 'Overlay', annotationMode: 'Overlay', detectionMode: 'Boxes',
  attentionType: 'Probability', lesionClass: 'HE', enabledClasses: ['MA', 'HE', 'EX', 'SE'], opacity: 0.5, rawRegions: false, topK: DEFAULT_TOP_K, regionClass: 'all' };
