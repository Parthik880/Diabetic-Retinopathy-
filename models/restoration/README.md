...
`2b4af71ebe098a92a75910c233a3965a3e93ede4`. The upstream Apache 2.0 license is
included in `nafnet/LICENSE`; source copyright and attribution headers are retained.
...
file limit, and is therefore not committed. It can be downloaded from the
upstream NAFNet model links and passed with `--checkpoint`. It is a SIDD
denoising checkpoint, not a retinal-trained model.
